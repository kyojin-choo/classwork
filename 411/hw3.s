...
c_loop:
  ...
  d_loop:		
		...
		ldr r5, [r10, r4]       /* Load in D[location] */
		mul r7, r6, r5          /* temp = B[i] * A[j] */
		mov r5, r7              /* Insert temp into D. */
		add r8, r8, #4          /* Add 4 to the offset counter.*/
		add r4, r4, #4          /* Add 4 to D counter. */           
		mov r7, #0              /* Reset temp */
	...
	add r9, r9, r7            /* Add the product to C */
	add r0, r0, #1            /* Increment by 1; counter */
	add r3, r3, #4            /* Increment by 4; offset */	
